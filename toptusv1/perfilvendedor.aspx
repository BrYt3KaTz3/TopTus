...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <meta property="og:image" content="http://demo.toptus.com/vendedor/perfil/<%#imagen%>"/>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="fb-share-button" data-href="http://demo.toptus.com/perfilvendedor.aspx?vendedor=<%#hdid.Value%>" data-layout="button_count"></div>
        </div>
            ...
            <div class="row" id="post-review-box" >
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6 text-center">
                        <h1 class="rating-num">
                            <%#cali_general %> </h1>
                        <span class="text-muted text-center">de 100</span>
                        <div class="rating">
                            <img src="imagenes/estrellas<%#foto_cali %>.png"  class="img-responsive"/>
                            
                        </div>
                        <div>
                            <span class="glyphicon glyphicon-user"></span><%#registros %> total
                        </div>
                    </div>
                        ...
                        <div class="row rating-desc">
                            ...
                            <div class="col-xs-8 col-md-9">
                                <div class="progress progress-striped">
                                    <div class="progress-bar progress-bar-success active" role="progressbar" aria-valuenow="20"
                                        aria-valuemin="0" aria-valuemax="100" style="width: <%#diez %>%">
                            ...
                            <div class="col-xs-8 col-md-9">
                                <div class="progress">
                                    <div class="progress-bar progress-bar-success active" role="progressbar" aria-valuenow="20"
                                        aria-valuemin="0" aria-valuemax="100" style="width: <%#ocho %>%">
                            ...
                            <div class="col-xs-8 col-md-9">
                                <div class="progress">
                                    <div class="progress-bar progress-bar-info active" role="progressbar" aria-valuenow="20"
                                        aria-valuemin="0" aria-valuemax="100" style="width: <%#seis %>%">
                            ...
                            <div class="col-xs-8 col-md-9">
                                <div class="progress">
                                    <div class="progress-bar progress-bar-warning active" role="progressbar" aria-valuenow="20"
                                        aria-valuemin="0" aria-valuemax="100" style="width: <%#cuatro %>%">
                            ...
                            <div class="col-xs-8 col-md-9">
                                <div class="progress">
                                    <div class="progress-bar progress-bar-danger active" role="progressbar" aria-valuenow="80"
                                        aria-valuemin="0" aria-valuemax="100" style="width: <%#dos %>%">
                                        <span class=""><%#dos %>%</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-8 col-md-9">
                                <div class="progress">
                                    <div class="progress-bar progress-bar-danger active" role="progressbar" aria-valuenow="80"
                                        aria-valuemin="0" aria-valuemax="100" style="width: <%#cero %>%">
                    ...
                    <div class="col-md-6"><input id="ratings-hidden" name="rating" type="hidden">
                        <asp:HiddenField ID="ratings" ClientIDMode="Static" runat="server" />
                       
        
                        <div class="text-center">
                            <div class="stars starrr" data-rating="0"></div>
                           
                            <asp:Button ID="btnCalificar" CssClass="btn btn-success btn-lg" OnClick="btnCalificar_Click" runat="server" Text="Calificar" />
...
<script>(function (d, s, id) {
    ...
    <div id="dialog-message" title="Mensaje" style="display:none;">
  <p id="mensaje">
